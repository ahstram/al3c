...
**If you have MPI libraries already installed, please skip to the "From source" example. Existing MPI libraries will likely interfere with the Linux and OS-X binaries we provide below.**
