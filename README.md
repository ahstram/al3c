...
<TITLE>al3c, Approximation Bayesian Computation in Parallel</TITLE>

<META NAME="description" CONTENT="The homepage for al3c, a framework for doing Approximate Bayesian Computation in parallel"> 
...
<div id="wrapper" style="width:100%;
    ...
    <div id="content" style="min-width:560px;
    width:54%;
    float:left;
    margin-right:0px;
	word-break: break-all;
...
<hr>
<P><pre>         <b>_______</b>     
  ____ _<b>/ /__  /</b>_____  a software framework for numerical approximations
 / __ `<b>/ / /_ &gt</b>/ ___/  of posterior distributions by Approximate
/ /_/ <b>/ /___/ /</b> /__    Bayesian Computation Sequential Monte Carlo
\__,_<b>/_//____/</b>\___/    in parallel 

</pre>
<hr>
<pre>
<i>al3c</i> is meant to be as abstract & flexible as possible. 
